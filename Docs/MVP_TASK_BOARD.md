...
| E-6 | Add automated Luau tests | Assistant | Done | 255 assertions across nine server/client suites |
| E-7 | Split oversized runtime scripts | Assistant | In Progress | Spectator, input, weapons, and aiming/IK extracted; UI/feedback remain |

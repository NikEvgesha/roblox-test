...
| E-6 | Add automated Luau tests | Assistant | Done | 229 assertions across eight server/client suites |
| E-7 | Split oversized runtime scripts | Assistant | In Progress | Input and weapon dispatch extracted; client aiming/IK and UI remain |

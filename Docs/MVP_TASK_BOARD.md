...
| E-6 | Add automated Luau tests | Assistant | Done | `GameRulesTests` 26; `WaveDirectorTests` 19; `EnemyRuntimeTests` 18; `EnemyFactoryTests` 41 |
| E-7 | Split oversized runtime scripts | Assistant | In Progress | Wave, enemy runtime, and enemy factory extracted; revive and client controllers remain |

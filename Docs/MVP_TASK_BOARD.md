...
| E-6 | Add automated Luau tests | Assistant | Done | `GameRulesTests` 26 assertions; `WaveDirectorTests` 19; `EnemyRuntimeTests` 18 |
| E-7 | Split oversized runtime scripts | Assistant | In Progress | `WaveDirector` and `EnemyRuntime` extracted and Play Mode verified; factory, revive, and client controllers remain |

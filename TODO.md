...
3. The combat client remains oversized; gameplay controllers are extracted, while draft UI and combat-feedback presentation still share `main.client.lua`.
...
| Done | Add pure logic test modules | Assistant | Combat Studio passes 255 assertions across nine server/client suites |
...
| P1 | Extract combat client controllers | Assistant | Gameplay controllers are done; UI and combat-feedback presentation are separated next |

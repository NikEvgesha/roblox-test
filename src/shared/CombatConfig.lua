	...
	Zombies = {
		...
		WaveTable = {
			...
			},
			{
				...
				Weights = { Walker = 60, Crawler = 20, Runner = 20 },
			},
			{
				MinWave = 25,
				MaxWave = 49,
				...
				Weights = { Walker = 36, Crawler = 20, Runner = 22, Spitter = 22 },
			},
			{
				MinWave = 50,
				MaxWave = 74,
				...
				Weights = { Walker = 24, Crawler = 16, Runner = 20, Spitter = 20, Flyer = 20 },
			},
			{
				MinWave = 75,
				...
				Weights = { Walker = 14, Crawler = 12, Runner = 20, Spitter = 22, Flyer = 18, Bomber = 14 },
			},
		},

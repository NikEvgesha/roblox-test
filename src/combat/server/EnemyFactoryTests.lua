...
function EnemyFactoryTests.Run()
	...
	local templateBounds, templateSize = templateModel:GetBoundingBox()
	near(templateBounds.Position.Y - templateSize.Y * 0.5, 20.1, 0.000001, "template rests on ground")
